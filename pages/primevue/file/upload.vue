<template>
  <div>
    <Card class="component-title">
      <template #content>
        <BackButton />
        <Button label="File Upload Demos" severity="info" disabled class="flex-1" />
      </template>
    </Card>
    <Card>
      <template #title>Basic Upload</template>
      <template #content>
        <FileUpload mode="basic" name="basic" url="/api/upload" accept="image/*" :maxFileSize="1000000"
          @upload="onUpload" />
      </template>
    </Card>
    <Card>
      ...
      <template #content>
        <FileUpload name="advanced" url="/api/upload" :multiple="true" accept="image/*" :maxFileSize="1000000"
          @upload="onUpload" :customUpload="true" @uploader="customUploader">
          ...
          <template #empty>
            <div class="flex align-items-center flex-column">
              <i class="pi pi-image mt-3 p-5"
                style="font-size: 5em; border-radius: 50%; background-color: var(--surface-b)" />
    ...
    <Card>
      ...
      <template #content>
        <FileUpload name="auto" url="/api/upload" :multiple="true" accept="image/*" :maxFileSize="1000000"
    ...
    <Card>
      ...
      <template #content>
        <FileUpload name="template" @uploader="customUploader" :customUpload="true" accept="image/*"
          :maxFileSize="1000000" :multiple="true">
